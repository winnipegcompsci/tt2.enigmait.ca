<div class="wtcrInventory view col-lg-6 col-md-9 columns">
    ...
    <div class="row">
        <div class="large-5 columns strings">
            <h6 style="display: inline" class="subheader"><?= __('Wtcr Sku') ?></h6>
            <p style="display: inline"><?= h($wtcrInventory->wtcr_sku) ?></p>
            <h6 style="display: inline" class="subheader"><?= __('Product Name') ?></h6>
            <p style="display: inline"><?= h($wtcrInventory->product_name) ?></p>
            <h6 style="display: inline"class="subheader"><?= __('Wtcr Product Category') ?></h6>
            ...
            <h6 style="display: inline" class="subheader"><?= __('Mfg Part Number') ?></h6>
            <p style="display: inline"><?= h($wtcrInventory->mfg_part_number) ?></p>
            <h6 style="display: inline" class="subheader"><?= __('Wtcr Vendor') ?></h6>
            ...
            <h6 style="display: inline" class="subheader"><?= __('Vendor Sku') ?></h6>
