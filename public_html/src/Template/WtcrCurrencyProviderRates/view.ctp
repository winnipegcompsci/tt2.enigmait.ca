...
<div class="wtcrCurrencyProviderRates view large-10 medium-9 columns">
    <h2><?= h($wtcrCurrencyProviderRate->id) ?></h2>
    <div class="row">
        <div class="large-5 columns strings">
            <h6 class="subheader"><?= __('Wtcr Currency') ?></h6>
            <p><?= $wtcrCurrencyProviderRate->has('wtcr_currency') ? $this->Html->link($wtcrCurrencyProviderRate->wtcr_currency->name, ['controller' => 'WtcrCurrencies', 'action' => 'view', $wtcrCurrencyProviderRate->wtcr_currency->id]) : '' ?></p>
