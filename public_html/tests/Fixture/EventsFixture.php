...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'events_ibfk_1' => ['type' => 'foreign', 'columns' => ['ticket_id'], 'references' => ['tickets', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'latin1_swedish_ci'
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'timestamp' => '2015-03-17 02:05:43',
            'billing_type_id' => 1,
            'time_type_id' => 1,
            'time_taken' => 1,
            'is_resolution' => 'Lorem ipsum dolor sit ame',
            'resolution_date' => '2015-03-17 02:05:43',
            'time_start' => '2015-03-17 02:05:43',
            'time_end' => '2015-03-17 02:05:43'
        ],
    ];
}
